...
1. In the **Upload blob** pop-up window, perform the following actions:
    ...
    b. In the **File Explorer** window, browse to **C:\gitfiles\AZ-204-DevelopingSolutionsforMicrosoftAzure-master\Allfiles\Labs\12\Starter**, select the following files, and then select **Open**:
...
1. In the **Upload blob** pop-up window, perform the following actions:
    ...
    b. In the **File Explorer** window, browse to **C:\gitfiles\AZ-204-DevelopingSolutionsforMicrosoftAzure-master\Allfiles\Labs\12\Starter**, select the **welcome.mp4** file, and then select **Open**.
