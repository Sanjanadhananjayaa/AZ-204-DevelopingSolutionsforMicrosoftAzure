...
1. In the **Upload blob** pop-up window, perform the following actions:
    ...
    b. In the **File Explorer** window, browse to **C:\gitfilesFiles\AZ-204-DevelopingSolutionsforMicrosoftAzure-master\Allfiles\Labs\12\Starter**, select the following files, and then select **Open**:
