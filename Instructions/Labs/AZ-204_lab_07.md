...
1. In the Azure portal, use the **Search resources, services, and docs** text box to search for **Storage Accounts**, and then in the list of results, select **Storage accounts**.
   ...
   ![Screenshot displaying the configured settings on the Create a storage account blade](./media/image06-az204-lab07.png)

1. On the **Storage accounts** blade, select **+ Create**.

1. On the **Create a storage account** blade, on the **Basics** tab, perform the following actions and click on **Next**.
   ...
   ![Screenshot displaying the configured settings on the Create a storage account blade](./media/image13-az204-lab07.png)
...
1. On the **Advanced** tab, ensure **Allow enabling anonymous access on individual containers** is checked. Check the settings if they are not enabled, and then select **Review + create**.
    ...
    ![Screenshot displaying the configured settings on the Create a storage account blade](./media/image07-az204-lab07.png)
...
1. On the Deployment Overview blade, select **Go to resource**.
    ...
    ![Screenshot displaying the configured settings on the Create a storage account blade](./media/image08-az204-lab07.png)
...
1. In the Azure portal, use the **Search resources, services, and docs** text box to search for **Key vaults**, and then in the list of results, select **Key vaults**.
     ...
     ![Screenshot displaying the configured settings on the Create a storage account blade](./media/image10-az204-lab07.png)
   
3. On the **Key vaults** blade, select **+ Create**.

4. On the **Create key vault** blade, on the **Basics** tab, perform the following actions, and then select **Access Configuration** tab:
   ...
   ![Screenshot displaying the configured settings on the Create a storage account blade](./media/image11-az204-lab07.png)

5. On the **Access Configuration** tab, change the permission model to **Vault access policy**.

6. Select the **Review + create** tab, and review the options that you selected during the previous steps.

7. Select **Create** to create the key vault by using your specified configuration.
...
1. On the **Key Vault** blade, select the **Secrets** under the **Objects** section. Select **+ Generate/Import**.

    ![Screenshot displaying the configured settings on the Create a storage account blade](./media/image15-az204-lab07.png)
...
1. On the **Versions** pane, select the latest version of the **storagecredentials** secret.
      ...
      ![Screenshot displaying the configured settings on the Create a storage account blade](./media/image16-az204-lab07.png)
...
1. On the **Secret Version** pane, perform the following actions:
    ...
    - Select **Show secret value** to find the value of the secret.
       ...
       ![Screenshot displaying the configured settings on the Create a storage account blade](./media/image17-az204-lab07.png)
